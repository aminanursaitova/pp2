...
pygame.display.set_caption("Pavlin")
icon = pygame.image.load('images/man.webp').convert_alpha()
pygame.display.set_icon(icon)

bg = pygame.image.load('images/bg.png').convert_alpha()
ghost = pygame.image.load('images/gh2.png').convert_alpha() 
ghost_list_in_game = []
walk_left = [
...
bg_sound = pygame.mixer.Sound('sounds/sn.mp3')
bg_sound.play()
...
label = pygame.font.Font('fonts/KZ_Lobster.ttf', 40)
lose_label = label.render('Жеңілдіңіз!', True, (193, 196, 199))
restart_lable = label.render('Қайтадан', True, (115, 132, 148))
restart_lable_rect = restart_lable.get_rect(topleft=(230 ,200))
...
while running:
    ...
    if gameplay:
        ...
        elif keys[pygame.K_RIGHT] and player_x < 616:
            player_x += player_speed
